...
public class GameChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public GameChannelInitializer(IEventManager eventManager, IPluginManager pluginManager, ServiceProvider serviceProvider) {
    ...
    protected void initChannel(SocketChannel channel) {
        ...
        pipeline.addLast("clientHandler", new GameNetworkHandler(this.eventManager, this.pluginManager, this.serviceProvider));
    }
}